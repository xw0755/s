...
ClassExtend = function() {
    ...
    if (len > 1) {
        ...
        Olinherit.apply(null, newArgs);
    } else {
        C.prototype = F;
    }
    return C;
};
Olinherit = function(C, P) {
   var F = function() {};
   ...
   for(i=2, l=arguments.length; i<l; i++) {
       ...
       olextend(C.prototype, o);
   }
};

olextend = function(destination, source) {
 ...
 *  - <OpenLayers.Layer>
 */
Heatmap.Layer = ClassExtend(ol.layer, {
  ...
  initialize: function(name, options) {
    ol.Layer.prototype.initialize.apply(this, arguments);
    this.points = [];
    this.cache = {};
